...
def main(args):
    ...
    info = new_info
    all_res = []
    output_dir = os.path.join(args.save_result_path, f"sspred_{accelerator.process_index}.json")
    ...
    cnt = -1
    for item in info:
        # if item["dataset_name"] != "ImageNeedleInAHaystack" or item["sample_id"] not in [140,174]:
        #     continue
        cnt += 1
...
def parse_args():
    ...
    parser.add_argument("--root_path", type=str, default="/cpfs/user/wangpengfei2/project/Qwen2VL/attn_score_analysis/qwen2vl-2B")
