...
def main(args):
    ...
    for item in info:
        ...
        if item["dataset_name"] != "SlideVQA" or item["sample_id"] not in [147]:  # ImageNeedleInAHaystack SlideVQA
            continue
        cnt += 1
...
def parse_args():
    ...
    parser.add_argument("--attn_mode", type=int, default=3, choices=[1, 2, 3])
    ...
    if args.attn_mode == 1:
        ...
        # args.save_attn = [
        #     list(range(0, int(total_layer//4))),
        #     list(range(total_layer//4, total_layer*2//4)),
        #     list(range(total_layer*2//4, total_layer*3//4)),
        #     list(range(total_layer*3//4, total_layer))
        # ]
        # args.save_attn = [
        ...
        # ]
        args.save_attn = [
            list(range(0, int(total_layer//2))),
            list(range(total_layer//2, total_layer))
        ]
