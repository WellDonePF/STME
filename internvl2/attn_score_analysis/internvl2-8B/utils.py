...
def fun1():
    all_file_path = [
        f"/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-8B/{args.task_type}/info/pred0.json",
    ]
    all_dir_path = [
        f"/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-8B/{args.task_type}/bench_res{num}"
            for num in range(2)
    ]
    all_res = []
...
if __name__ == "__main__":
    ...
    for fun_num in args.function:
        if int(fun_num) == 1:
            ...
            cal_matrix()
    print(len(os.listdir(f"/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-8B/{args.task_type}/scores")))
