...
def cal_head_weights(args):
    ...
    while True:
        ...
        cnt = -1
        for item in info:
            # if item["dataset_name"] != "GPR1200" or item["sample_id"] not in [261]:  # SlideVQA nuscenes GPR1200
            #     continue
            cnt += 1
...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/pretrained/InternVL2-4B")
    parser.add_argument("--root_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-4B")
