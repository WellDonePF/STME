...
def plot_figure(metric_values, acc):
    ...
    if args.task_type == "easy":
        title_ = "Easy Tasks"
    title_ += "   Qwen2VL-" + args.model_name.split("-")[-1]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root_path", type=str, default="D:/Project/python3/STME/qwen2vl/attn_score_analysis")
    parser.add_argument("--metric_path", type=str, default="D:/Project/python3/STME/qwen2vl/metric")
    ...
    parser.add_argument("--N", type=list, default=list(range(1,29)))
