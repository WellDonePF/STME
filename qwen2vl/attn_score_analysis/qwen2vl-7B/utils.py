...
def fun1():
    all_file_path = [
        f"/cpfs/user/wangpengfei2/project/Qwen2VL/attn_score_analysis/qwen2vl-7B/{args.task_type}/info/pred0.json",
    ]
    all_dir_path = [
        f"/cpfs/user/wangpengfei2/project/Qwen2VL/attn_score_analysis/qwen2vl-7B/{args.task_type}/bench_res{num}"
            for num in range(3)
    ]
    all_res = []
...
if __name__ == "__main__":
    ...
    for fun_num in args.function:
        if int(fun_num) == 1:
            ...
            cal_matrix()
    print(len(os.listdir(f"/cpfs/user/wangpengfei2/project/Qwen2VL/attn_score_analysis/qwen2vl-7B/{args.task_type}/scores")))
