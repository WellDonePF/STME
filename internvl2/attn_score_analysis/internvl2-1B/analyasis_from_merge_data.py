...
def cal_head_weights(args):
    ...
    while True:
        ...
        cnt = -1
        for item in info:
            # if item["dataset_name"] != "CM" or item["sample_id"] not in [2616]:  # 
            #     continue
            cnt += 1
...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/pretrained/InternVL2-1B")
    parser.add_argument("--root_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-1B")
