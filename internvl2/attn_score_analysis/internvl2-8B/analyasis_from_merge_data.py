...
def parse_args():
    ...
    parser.add_argument("--model_name_or_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/pretrained/InternVL2-8B")
    parser.add_argument("--root_path", type=str, default="/cpfs/user/wangpengfei2/project/InternVL/attn_score_analysis/internvl2-8B")
